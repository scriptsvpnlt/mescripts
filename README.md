...
### INSTALL SCRIPT 
<pre><code>apt install -y && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/scriptsvpnlt/mescripts/main/ins.sh && chmod +x ins.sh && ./ins.sh
</code></pre>
